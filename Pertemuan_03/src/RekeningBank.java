...
public class RekeningBank {
    ...
    public static final double BATAS_PENARIKAN = 5_000_000;  // konstanta publik
    public static final double BUNGA_TAHUNAN = 0.025;        // konstanta publik
    public static final double BIAYA_ADMINISTRASI = 5000;    // konstanta publik

    private static int jumlahRekening = 0;  // field statis penghitung jumlah rekening
    ...
    public void tarik(double jumlah) {
        if (jumlah <= 0 || jumlah > saldo || jumlah > BATAS_PENARIKAN) {
            throw new IllegalArgumentException("Jumlah tarik tidak valid");
        }
        saldo -= jumlah;
    }
